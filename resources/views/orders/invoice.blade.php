...
<head>
    ...
    <title>Invoice {{ $order->invoice_number }} — Skinist</title>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .invoice-date {
            font-size: 0.75rem; color: rgba(255,255,255,0.55); margin-top: 6px;
        }
        ...
        .item-total {
            font-size: 0.9rem; font-weight: 600; color: #1A3A5C;
            text-align: right;
            font-family: 'Cormorant Garamond', serif;
        }
        ...
        .total-final-value {
            font-family: 'Cormorant Garamond', serif;
            font-size: 1.5rem; font-weight: 600; color: #5BB8F5;
        }
        ...
        .payment-bank { font-size: 0.95rem; font-weight: 600; color: #1A3A5C; }
        .payment-note { font-size: 0.78rem; color: #5A7FA0; margin-top: 4px; }
        ...
        <div class="invoice-wrap animate-in">
            ...
            <div class="invoice-body">
                ...
                <div class="payment-info">
                    <p class="payment-info-label">Informasi Pembayaran</p>
                    <p class="payment-bank">BCA — 1234567890 a/n Skinist Store</p>
                    <p class="payment-note">Transfer sesuai total di atas, lalu upload bukti pembayaran di halaman pesanan.</p>
                </div>
                @endif
