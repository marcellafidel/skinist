...
<body class="bg-white min-h-screen flex flex-col items-center justify-center px-8">
    ...
    <div class="w-full max-w-md">
        <h2 class="text-2xl text-gray-600 mb-6">SignUp</h2>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-6">
                <div class="relative bg-gray-100 rounded-lg flex items-center">
                    ...
                    <button type="button" onclick="togglePassword('password_confirmation', 'eye2')"
                        class="px-4 text-gray-400 hover:text-sky-400 flex-shrink-0">
                        <svg id="eye2" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                        </svg>
                    </button>
            ...
            <p class="text-sm text-gray-400">
                have account?
                <a href="{{ route('login') }}" class="text-sky-400 hover:underline">Login here</a>
            </p>
        </form>
    </div>
