...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-links a:hover { color: #5BB8F5; }
        ...
        .divider-line { flex: 1; height: 1px; background: rgba(91,184,245,0.15); }
        .divider-text { font-size: 0.72rem; color: #5A7FA0; letter-spacing: 0.08em; }
...
<body>
    ...
    <div class="right-panel">
        <div class="form-wrap">
            ...
            <p class="form-subtitle">Masuk ke akun Skinist kamu</p>
            ...
            <a href="{{ route('register') }}" class="btn-register">Buat akun baru</a>
