...
<head>
    ...
    <title>Admin Brand — Skinist</title>
...
<body class="bg-sky-50 text-gray-800">
    ...
    <nav class="bg-white shadow-sm sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="{{ route('admin.brands') }}" class="text-sm text-sky-500 hover:underline font-bold">Brand</a>
    ...
    <main class="max-w-3xl mx-auto px-4 py-8">
        ...
        <h1 class="text-2xl font-bold text-gray-700 mb-8">🏷️ Kelola Brand</h1>
        ...
        <div class="bg-white rounded-3xl shadow-sm p-6 mb-6">
            <h2 class="text-lg font-bold text-gray-700 mb-4">Tambah Brand Baru</h2>
            <form action="{{ route('admin.brands.store') }}" method="POST" class="flex gap-3">
                @csrf
                <input type="text" name="name" placeholder="Nama brand..." required
        ...
        <div class="bg-white rounded-3xl shadow-sm overflow-hidden">
            <table class="w-full">
                <thead class="bg-sky-50 border-b border-sky-100">
                    <tr>
                        <th class="text-left px-6 py-4 text-sm text-gray-500 font-semibold">Nama Brand</th>
                ...
                <tbody>
                    ...
                    <tr class="border-b border-sky-50 hover:bg-sky-50 transition-colors">
                        <td class="px-6 py-4 font-semibold text-gray-700">{{ $brand->name }}</td>
                        <td class="px-6 py-4 text-sm text-gray-400">{{ $brand->slug }}</td>
                        <td class="px-6 py-4">
                    ...
                    @empty
                    <tr>
                        <td colspan="3" class="text-center py-12 text-gray-400">Belum ada brand.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
